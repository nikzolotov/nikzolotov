...
class SavingsChart extends React.Component {
  ...
  draw() {
    ...
    gBrush
      ...
      .call(brush)
      .call(brush.move, [
        width - margin.right - margin.left - xBrushStep * 18,
    ...
    function brushing() {
      ...
      // косяк: рамка тоже выбирается
      // косяк: столбцы выбираются не посередине
      gBrush
        .selectAll(".bar")
